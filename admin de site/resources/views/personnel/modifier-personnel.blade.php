...
@section('continu')
        ...
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- end page title -->
<form action="/modifierPersonnel" method="POST">
    @csrf
                                        ...
                                        <div class="row gy-4">
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="email" class="form-control" id="labelInput" placeholder="email" name="email"value={{$data->email}}>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <!--end col-->
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="labelInput" placeholder="password" name="password"value={{$data->password}}>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <!--end col-->
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="labelInput" placeholder="post" name="post"value={{$data->post}}>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="number" step="0.01" class="form-control" id="labelInput" placeholder="salaire" name="salaire"value={{$data->salaire}}>
                                                </div>
                                            </div>
                                            <!--end col-->
