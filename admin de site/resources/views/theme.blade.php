...
<body>
    ...
    <a href ="/list-contact" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" >
        <i class='bx bx-bell fs-22'></i>
        <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger">@include('userNotif')</span>
    </a>
</div>
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAdmin" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAdmin">
                        <i class="ri-admin-line"></i> <span data-key="t-admin">Admin</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarAdmin">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/ajout-admin" class="nav-link" data-key="t-ajout-admin"> Ajout Admin </a>
                            </li>
                            <li class="nav-item">
                                <a href="/list-admin" class="nav-link" data-key="t-list-admin"> List Admin </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPersonnel" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPersonnel">
                        <i class="ri-user-line"></i> <span data-key="t-personnel">Personnel</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarPersonnel">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="/list-personnel" class="nav-link" data-key="t-list-personnel"> List Personnel </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarProjet" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarProjet">
                        <i class="ri-projector-line"></i> <span data-key="t-projet">Projet</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarProjet">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="/list-projet" class="nav-link" data-key="t-list-projet"> List Projet </a>
                            </li>
                        </ul>
                    </div>
                </li>
<!-- Contact Menu -->
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarContact">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/ajout-contact" class="nav-link" data-key="t-ajout-contact"> Ajout Contact </a>
                            </li>
                            <li class="nav-item">
                                <a href="/list-contact" class="nav-link" data-key="t-list-contact"> List Contact </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarTable" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarTable">
                        <i class="ri-table-line"></i> <span data-key="t-table">Tache</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarTable">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="/list-tache" class="nav-link" data-key="t-list-table"> List Tache</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarCategorie" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCategorie">
                        <i class="ri-list-unordered"></i> <span data-key="t-categorie">Categorie</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarCategorie">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/ajout-categorie" class="nav-link" data-key="t-ajout-categorie"> Ajout Categorie </a>
                            </li>
                            <li class="nav-item">
                                <a href="/list-categorie" class="nav-link" data-key="t-list-categorie"> List Categorie </a>
                            </li>
                        </ul>
                    </div>
                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by Jasser Ben Jemma
                            </div>
                        </div>
                    </div>
                </div>
