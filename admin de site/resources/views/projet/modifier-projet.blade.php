                                        ...
                                        <div class="row gy-4">
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="placeholderInput" placeholder="deadline" name="deadline"value={{$data->deadline}}>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="number" class="form-control" id="placeholderInput" placeholder="prix" name="prix"value={{$data->prix}}>
                                                </div>
                                            </div>
                                            <!--end col-->
