                                        ...
                                        <div class="row gy-4">
                                            ...
                                            <div>
                                                <div>
                                                    <label for="labelInput" class="form-label">description</label>
                                                        <input type="text" class="form-control" id="labelInput" placeholder="description" name="description">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <!--end col-->
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="labelInput" placeholder="state" name="state">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <!--end col-->
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="labelInput" placeholder="avance" name="avance">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <!--end col-->
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="labelInput" placeholder="personnel_id" name="personnel_id">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="date" class="form-control" id="labelInput" placeholder="date" name="date">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <!--end col-->
                                            <div>
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="labelInput" placeholder="projet" name="projet">
                                                </div>
                                            </div>
                                            <!--end col-->
